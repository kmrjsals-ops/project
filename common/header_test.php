...
<header>
  ...
  <div class="m_user_info">
    <ul>
      <!-- 로그인 상태 -->
      <li>
        <a href="../user/mypage.php" title="마이페이지"><img src="../images/user_admin/img_upload.png" alt="프로필이미지"></a>
      </li>

      <!-- 비로그인 -->
      <li>
        <a href="../php/login.php" title="로그인하기">로그인</a>
      </li>
    </ul>
  </div>
  ...
  <div class="m_nav_panel">
    ...
    <nav class="m_nav_list">
      <ul>
        <li><a href="../user/game.php" title="게임">GAME</a></li>
        <li><a href="../user/notice.php" title="뉴스">NEWS</a></li>
        <li><a href="../user/community.php" title="라운지">LOUNGE</a></li>
        <li><a href="" title="서포트">SUPPORT</a></li>
      </ul>
    </nav>
    
    <div class="m_logout_btn_wrap">
      <a href="../php/logout.php" title="로그아웃" class="m_logout_btn">로그아웃</a>
    </div>
  </div>
