        ...
        <div class="col-12 col-md-5">
          ...
          <form action="../php/reset_pw_ok.php" method="post">
            ...
            <div class="mb-4">
              ...
              <input type="password" id="log_pw" name="new_pw" class="form-control p-2"
              placeholder="10~20자 이내 영문/숫자/특수문자 2가지 이상의 글자 조합" required/>
            </div>
            
            <!-- 2. 새 비밀번호 확인 -->
            <div class="mb-4">
              <label class="form" for="log_new_pw">새 비밀번호</label>
              <input type="password" id="log_new_pw" name="new_pw_check" class="form-control p-2"
